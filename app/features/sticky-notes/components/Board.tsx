        ...
        {isSupabaseEnabled() ? (
          isAuthenticated ? (
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 mt-2 w-64 p-3 bg-gray-800 text-white text-sm rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="font-semibold mb-2">ログインのメリット</div>
                <ul className="space-y-1 text-xs">
                  <li className="flex items-start gap-1">
                    <span className="text-green-400">✓</span>
                    <span>付箋をクラウドに自動保存</span>
                  </li>
                  <li className="flex items-start gap-1">
                    <span className="text-green-400">✓</span>
                    <span>複数端末で同期</span>
